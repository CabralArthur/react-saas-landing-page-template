        ...
        <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
            <div className="flex p-px lg:col-span-4">
              <div className="overflow-hidden rounded-lg bg-slate-800 ring-1 ring-white/15 max-lg:rounded-t-[2rem] lg:rounded-tl-[2rem]">
                <img
                  alt=""
            ...
            <div className="flex p-px lg:col-span-2">
              <div className="overflow-hidden rounded-lg bg-slate-800 ring-1 ring-white/15 lg:rounded-tr-[2rem]">
                <img
                  alt=""
            ...
            <div className="flex p-px lg:col-span-2">
              <div className="overflow-hidden rounded-lg bg-slate-800 ring-1 ring-white/15 lg:rounded-bl-[2rem]">
                <img
                  alt=""
            ...
            <div className="flex p-px lg:col-span-4">
              <div className="overflow-hidden rounded-lg bg-slate-800 ring-1 ring-white/15 max-lg:rounded-b-[2rem] lg:rounded-br-[2rem]">
                <img
                  alt=""
